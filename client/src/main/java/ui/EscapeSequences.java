...
public class EscapeSequences {
    ...
    public static final String SET_TEXT_COLOR_LIGHT_TAN = SET_TEXT_COLOR + "223m";
    public static final String SET_TEXT_COLOR_DARK_TAN = SET_TEXT_COLOR + "180m";
    public static final String SET_TEXT_COLOR_DARK_BROWN = SET_TEXT_COLOR + "94m";
    ...
    public static final String SET_BG_COLOR_DARK_TAN = SET_BG_COLOR + "180m";
